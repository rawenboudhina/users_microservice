...
import com.rawen.users.security.JWTAuthenticationFilter;
import com.rawen.users.security.JWTAuthorizationFilter;
...
public class Securityconfig {
	 ...
	 * userDetailsService) throws Exception { return
	 ...
	 * and() .authorizeHttpRequests() .requestMatchers("/login").
	 * 
	 * permitAll().requestMatchers("/all").hasAuthority("ADMIN")
